...
<head>
    ...
    <title>{{ __('Reset Password') }} - Sophisticate Intensive Classes</title>
                    ...
                    <div class="mb-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
                        <div class="flex items-start space-x-3">
                            ...
                            <p class="text-sm text-blue-700">
                                {{ __('Please enter your new password below. Make sure it\'s at least 8 characters and includes a mix of letters and numbers for better security.') }}
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl bg-gray-50 text-gray-700 cursor-not-allowed"
                                    readonly>
                            </div>
                            @error('email')
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative" x-data="{ show: false }">
                                ...
                                <input :type="show ? 'text' : 'password'" name="password_confirmation"
                                    ...
                                    class="w-full pl-10 pr-12 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all @error('password_confirmation') border-red-300 bg-red-50 @enderror"
