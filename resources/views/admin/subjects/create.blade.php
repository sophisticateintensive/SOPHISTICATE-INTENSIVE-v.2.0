...
@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-[var(--text-secondary)] mt-1">Add a new academic course to the system</p>
        </div>
...
@section('content')
    <style>
        ...
        @media (max-width: 1024px) {
            ...
            .create-container::before { display: none; }
        }
        ...
        /* Credit Hours radio buttons (glass style) */
        .credit-grid {
            display: grid;
        ...
        .credit-option label .number {
            font-size: 1.5rem;
            font-weight: 700;
        }
        .credit-option label .text {
            font-size: 0.7rem;
            text-transform: uppercase;
            letter-spacing: 0.05em;
        }
        ...
        @media (max-width: 640px) {
            ...
            .create-container { margin-bottom: 90px; }
    ...
    <div class="create-container">
        ...
        <div class="form-panel">
            ...
            <form action="{{ route('admin.subjects.store') }}" method="POST" id="courseForm">
                @csrf
                    ...
                    <div class="credit-grid">
                        @foreach([1, 2, 3, 4, 5, 6] as $hours)
                            <div class="credit-option">
                                <input type="radio" name="credit_hours" id="credit_{{ $hours }}" value="{{ $hours }}"
                                    {{ old('credit_hours', 3) == $hours ? 'checked' : '' }} required>
                                <label for="credit_{{ $hours }}">
                                    <span class="number">{{ $hours }}</span>
                                    <span class="text">{{ $hours == 1 ? 'Credit' : 'Credits' }}</span>
                                </label>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="info-box">
                    ...
                    <div>
                        <h5 class="text-sm font-semibold text-blue-800 dark:text-blue-300">Course Information Guide</h5>
                        <p class="text-xs text-blue-600 dark:text-blue-400 mt-1">
                            Course codes should be unique and follow the format: Department code + Number (e.g., CS101, MATH201, PHY101). Credit hours determine the weight of the course in the curriculum.
                        </p>
                    </div>
                </div>
            </form>
